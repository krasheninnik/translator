...
#pragma region InitiationTransitionMatrix
	...
	transitionMatrix[START][NEW_LINE] = OUT;  
	...
	transitionMatrix[OPEN_QUOTE][BACKSLASH] = WAIT_SPEC_SYMBOL;
	...
	transitionMatrix[WAIT_SPEC_SYMBOL][LETTER] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][DECIMAL] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][SLASH] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][ASTERISK] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][QUOTE] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][BACKSLASH] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][DELIMETER_SKIP_EV] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][DELIMETER_EV] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][NEW_LINE] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][INVALID_CHARACTER] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][OPERATION_LEFT] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][OPERATION_RIGHT] = SPEC_SYMBOL;
	transitionMatrix[WAIT_SPEC_SYMBOL][OPERTAION_EV] = SPEC_SYMBOL;
	...
	transitionMatrix[SPEC_SYMBOL][QUOTE] = CLOSE_QUOTE;
